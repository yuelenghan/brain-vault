...
5. Prefer the fixed report paths in the current OS temp directory: `optimize-vault.json` and `optimize-vault.md`. Do not pass other report paths or `--vault` to the optimizer script.
